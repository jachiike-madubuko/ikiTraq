...
// https://github.com/ihmpavel/expo-video-player/blob/master/lib/index.tsxx`
// https://docs.expo.io/versions/v37.0.0/sdk/video/
// https://cloud.google.com/bigquery/external-data-drive
// https://player.vimeo.com/play/1809184589?s=419198131_1589613365_13aeaaa942b6b97b65ce5e106aca447b&loc=external&context=Vimeo%5CController%5CFileTransferController.main_ajax&download=1
...
import { PlayIcon, PauseIcon, ExpandIcon, MantraIcon } from '../AtomicDesignSystem/Atoms/Icon.atom'
...
const defaultProps = {
    ...
    // Icons
    playIcon: PlayIcon,
    replayIcon: MantraIcon,
    pauseIcon: PauseIcon,
    spinner: Spinner,
    fullscreenEnterIcon: ExpandIcon,
    fullscreenExitIcon: ExpandIcon,
